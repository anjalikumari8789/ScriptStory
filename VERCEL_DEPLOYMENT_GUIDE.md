# ScriptStory Deployment Guide for Vercel

This guide shows how to deploy ScriptStory (MongoDB, Express, React, Node.js) to Vercel using separate frontend and backend deployments, with proper authentication and cross-site cookie handling.
...
- Vercel account
- GitHub repository with your ScriptStory project
...
This guide should help you deploy ScriptStory to Vercel successfully. Remember to update domain names, API endpoints, and environment variables according to your specific project needs.
